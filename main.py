...
async def q3_answer(request: Request):
    ...
    prompt = (
        ...
        "   answerable: true, answer: <grounded answer>, citations: [<chunk_ids used>], confidence: 0.8-1.0\n"
...
async def graph_query(request: Request):
    ...
    prompt = (
        ...
        "Given the knowledge graph (entities and relationships), answer the question.\n"
        "Determine the logical path through the graph to find the answer.\n"
        "Return strictly JSON:\n"
        '{ "answer": "Brief factual answer", "reasoning_path": ["Entity1", "Entity2"], "hops": 2 }\n\n'
...
async def community_summary(request: Request):
    ...
    prompt = (
        "You are a GraphRAG community summarizer. Summarize this community of entities/relationships "
        "as a concise paragraph explaining how they connect and their overall theme.\n"
        "Return strictly JSON:\n"
        "{\n"
